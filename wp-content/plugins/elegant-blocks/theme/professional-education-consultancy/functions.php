...
function bizberg_after_import( $selected_import ) {
	...
	switch ( $import_file_name ) {
		...
		case 'PEC Homepage Free':			
			$args['default_page']['page_on_front'] = 'pec-homepage-free';
			bizberg_set_defaults( $args );
			break;

		case 'Simple Homepage Free':			
			$args['default_page']['page_on_front'] = 'homepage-free';
			bizberg_set_defaults( $args );
			break;

		case 'Transparent Header':			
			$args['default_page']['page_on_front'] = 'homepage-transparent';
			bizberg_set_defaults( $args );
			break;

		case 'Homepage Slider 1':			
			$args['default_page']['page_on_front'] = 'homepage-slider-1';
			bizberg_set_defaults( $args );
			break;

		case 'Homepage Slider 2':			
			$args['default_page']['page_on_front'] = 'homepage-slider-2';
			bizberg_set_defaults( $args );
			break;

		case 'Homepage Slider 3':			
			$args['default_page']['page_on_front'] = 'homepage-slider-3';
			bizberg_set_defaults( $args );
			break;
...
function bizberg_set_defaults( $args ){
	...
	$args['search_replace'][] = 'pec-homepage-free';
	$args['search_replace'][] = 'homepage-free';
	$args['search_replace'][] = 'homepage-transparent';
	$args['search_replace'][] = 'homepage-slider-1';
	$args['search_replace'][] = 'homepage-slider-2';
	$args['search_replace'][] = 'homepage-slider-3';
	$args['search_replace'][] = 'services';
...
function bizberg_search_replace_content( $slug ){
	...
	switch ( $slug ) {
		...
		case 'pec-homepage-free':
			...
			$contact_form_7_id = bizberg_set_contact_form_7_id( 'Become a Teacher' );
			...
			$content = str_replace( '"selectedGalleryCategoryID":"5"' , $category_new , $content );

			// Get Team Term ID
			$team_cat_id = bizberg_get_taxonomy_id_by_slug( 
				$cat_name = 'team', 
				$tax = 'ct_team_category' 
			);
			$category_new = '"selectedCategoryID":' . $team_cat_id;
			$content = str_replace( '"selectedCategoryID":6' , $category_new , $content );
			...
			$content = str_replace( '"selectedClientCatID":"7"' , $category_new , $content );

			// Get Courses
			$courses_cat_id = bizberg_get_taxonomy_id_by_slug( $cat_name = 'courses' , $tax = 'category' );
			$category_new = '"categories":"' . $courses_cat_id . '"';
			$content = str_replace( '"categories":"4"' , $category_new , $content );

			$content = str_replace( 'u00' , '\\\u00' , $content );
			$content = preg_replace( '/(\d)([n])/', wp_slash( '$1\\\$2' ), $content );

			// Get Blog
			$courses_cat_id = bizberg_get_taxonomy_id_by_slug( $cat_name = 'blog' , $tax = 'category' );
			$category_new = '"categories":"' . $courses_cat_id . '"';
			$content = str_replace( '"categories":"1"' , $category_new , $content );
		...
		case 'homepage-slider-3':
			...
			$content = str_replace( '"selectedSliderCategoryID":"8"' , $category_new , $content );
			...
			$category_new = '"selectedGalleryCategoryID":"' . $gallery_cat_id . '"';
			$content = str_replace( '"selectedGalleryCategoryID":"7"' , $category_new , $content );
			...
			$category_new = '"selectedCategoryID":' . $team_cat_id;
			$content = str_replace( '"selectedCategoryID":9' , $category_new , $content );

			// Get Client Term ID
			$client_cat_id = bizberg_get_taxonomy_id_by_slug( $cat_name = 'clients' , $tax = 'client_cat' );
			$category_new = '"selectedClientCatID":"' . $client_cat_id . '"';
			$content = str_replace( '"selectedClientCatID":"6"' , $category_new , $content );
			...
			$courses_cat_id = bizberg_get_taxonomy_id_by_slug( $cat_name = 'blog' , $tax = 'category' );
			$category_new = '"categories":"' . $courses_cat_id . '"';
			$content = str_replace( '"categories":"2"' , $category_new , $content );
